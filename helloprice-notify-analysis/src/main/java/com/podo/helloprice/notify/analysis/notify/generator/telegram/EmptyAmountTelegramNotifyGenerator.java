...
@Component
public class EmptyAmountTelegramNotifyGenerator extends AbstractTelegramNotifyGenerator {

    private static final Function<ProductDetailDto, String> CONTENTS = NotifyContents::notifyProductEmptyAmount;
