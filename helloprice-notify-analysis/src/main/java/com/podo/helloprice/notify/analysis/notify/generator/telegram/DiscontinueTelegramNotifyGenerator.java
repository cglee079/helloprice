...
@Component
public class DiscontinueTelegramNotifyGenerator extends AbstractTelegramNotifyGenerator {

    private static final Function<ProductDetailDto, String> CONTENTS = NotifyContents::notifyProductDiscontinued;
