...
@Component
public class DeadTelegramNotifyGenerator extends AbstractTelegramNotifyGenerator {

    private static final Function<ProductDetailDto, String> CONTENTS = NotifyContents::notifyProductDead;

    @Override
    public ProductUpdateStatus getProductUpdateStatus() {
        return ProductUpdateStatus.UPDATE_DEAD;
    }
