...
docker run -it -v /volume1/docker/podo-helloprice/podo-helloprice-telegram-qa/logs:/data/logs  --name=podo-helloprice-telegram-qa podo-helloprice-telegram-qa:1.0
