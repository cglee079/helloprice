...
docker run -it -p 25:25 -p 465:465 -p 587:587 -v /volume1/docker/podo-helloprice/podo-helloprice-telegram/logs:/data/logs  --name=podo-helloprice-telegram podo-helloprice-telegram:2.0
