...
import static com.podo.helloprice.code.model.ProductAliveStatus.ALIVE;
import static com.podo.helloprice.code.model.ProductAliveStatus.PAUSE;
...
class ProductTest {
    ...
    void testNewInstance01() {
        ...
        final ProductSaleStatus productSaleStatus = SALE;
        ...
        assertThat(product.getAliveStatus()).isEqualTo(ALIVE);
    ...
    void testAddProductNotify02() {
        //given
        final Product product = Product.builder().build();
        ReflectionTestUtils.setField(product, "aliveStatus", PAUSE);
    ...
    void testRemoveProductNotify02() {
        ...
        //then
        assertThat(product.getAliveStatus()).isEqualTo(PAUSE);
    }
