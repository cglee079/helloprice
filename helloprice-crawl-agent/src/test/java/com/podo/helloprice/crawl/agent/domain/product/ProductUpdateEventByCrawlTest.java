...
//        //given
//        final Product product = this.createDefaultProduct(1000);
//        product.getSaleTypeToPrice().remove(SaleType.CARD);
//        product.getSaleTypeToPrice().remove(SaleType.CASH);
//
//        final int crawledPrice = 1000;
//        final LocalDateTime crawledAt = LocalDateTime.now();
//        final CrawledProduct crawledProduct = createCrawledProduct(product, ProductSaleStatus.SALE, crawledPrice, crawledAt);
...
//        //then
//        assertThat(product.getSaleStatus()).isEqualTo(ProductSaleStatus.SALE);
//        assertThat(product.getSaleTypeToPrice().containsKey(SaleType.CASH)).isTrue();
//        assertThat(product.getSaleTypeToPrice().containsKey(SaleType.CARD)).isTrue();
//        assertThat(productUpdateStatuses).containsExactlyInAnyOrder(
//                UPDATE_SALE_CASH_PRICE,
//                UPDATE_SALE_CARD_PRICE
//        );
...
//        assertThat(product.getSaleTypeToPrice().get(SaleType.NORMAL)).extracting(ProductSale::getPrice).isEqualTo(0);
//        assertThat(product.getSaleTypeToPrice().get(SaleType.CASH)).extracting(ProductSale::getPrice).isEqualTo(0);
//        assertThat(product.getSaleTypeToPrice().get(SaleType.CARD)).extracting(ProductSale::getPrice).isEqualTo(0);
